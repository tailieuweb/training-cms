...
function comment_form($args = array(), $post_id = null)
{
	...
	$defaults = array(
		...
		'comment_field'        => sprintf(
			...
			'<textarea class="form-control" id="comment" name="comment" cols="45" rows="8" maxlength="65525" required="required"  placeholder="What are you thinking..."></textarea>'
		),
		'must_log_in'          => sprintf(
		...
		'class_submit'         => 'submit btn btn-primary btn-submit-comment',
		'name_submit'          => 'submit',
