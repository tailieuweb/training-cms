...
function comment_form($args = array(), $post_id = null)
{
    ...
    $defaults = array(
            ...
            '
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active make-a-post" id="posts-tab" data-toggle="tab" href="#posts" role="tab" aria-controls="posts" aria-selected="true">Make
                                    a Post</a>
                            </li>
                        </ul>
                    </div>
               ...
               class="custom-text-area"
                id="comment" placeholder="What are you thinking..." name="comment" 
        ...
        'logged_in_as' => sprintf(
            '<p class="logged-in-as my-title">%s</p>',
            sprintf(
        ...
        'submit_button' => '<input name="%1$s" type="submit" id="%2$s" class="%3$s custom-btn-share" value="Share" />',
