 ...
 * @param  string       $field   Optional. Published or modified time to use from database. Accepts 'date' or
 *                               'modified'. Default 'date'.
 ...
 * @type string   $file       Filename to be edited. Extension is used to sniff the type. Can be supplied as
