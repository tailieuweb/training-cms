...
<div class="col <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
    <div class="col-inner">
        <a href="<?php the_permalink() ?>" class="plain"> </a>
        <div class="box <?php echo $classes_box; ?> box-blog-post has-hover">
            ...
            <div class="box-shadow-readmore">
                <div class="box-text <?php echo $classes_text; ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
                    <div class="box-text-inner blog-post-inner">
                        ...
                        <p
                            class="cat-label <?php if($show_category == 'label') echo 'tag-label'; ?> is-xxsmall op-7 uppercase">
                            <?php
					...
					?>
                        ...
                        <?php if((!has_post_thumbnail() && $show_date !== 'false') || $show_date == 'text') {?><div
                            class="post-meta is-small op-8"><?php echo get_the_date(); ?></div><?php } ?>
                        <!-- <div class="is-divider"></div> -->
                        <?php if($show_excerpt !== 'false') { ?>
                        <p
                            class="from_the_blog_excerpt <?php if($show_excerpt !== 'visible'){ echo 'show-on-hover hover-'.$show_excerpt; } ?>"><?php
            ...
            <div class="badge absolute top rounded post-date badge-<?php echo $badge_style; ?>">
                <div class="badge-inner color-date">
