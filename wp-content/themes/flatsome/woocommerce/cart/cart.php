        ...
        <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
            <div class="cart-wrapper sm-touch-scroll">
                ...
                <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
                    <thead>
                        <tr class="bg-menu-product">
                            <th class="product-delete" colspan="1"><?php esc_html_e( 'Delete', 'woocommerce' ); ?></th>
                            <th class="product-imgae" colspan="1"><?php esc_html_e( 'Image', 'woocommerce' ); ?></th>
                            <th class="product-name" colspan="1"><?php esc_html_e( 'Product', 'woocommerce' ); ?></th>
                        ...
                        <tr
                            ...
                            <td class="product-remove">
								...
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="far fa-trash-alt"></i></a>',
...
<div class="row">
    <div class="col-md-6 br-coupon">
        <?php if ( wc_coupons_enabled() ) { ?>
        <form class="checkout_coupon mb-0" method="post">
            <h3 class="widget-title">
                <?php esc_html_e( 'Coupon', 'woocommerce' ); ?></h3>
            <div class="coupon">
                <p class="mb-coupon">Enter your coupon code if you have one.</p>
    ...
    <div class="col-md-6 border-cart">
        <?php
			/**
