 ...
 *
 */
function twentytwenty_site_logo($args = [], $echo = true) {
...
function twentytwenty_the_post_meta2($post_id = null, $location = 'single-top') {
    ...
    if ($post_meta && ! in_array('empty', $post_meta, true)) {
        ...
        <div class="post-meta-wrapper<?php echo esc_attr($post_meta_wrapper_classes); ?>">
            ...
            if (in_array('post-date', $post_meta, true)) {
                ...
                ?>
                <div class="meta-text">
                    <div class="meta-text-day">
                        <?php the_time(get_option('date_format')); ?>
                    </div>
                    <div class="meta-text-moth">
                        <?php the_time1(get_option('date_format')); ?>
                    </div>
                </div>
                <div class="meta-text-year">
                    <?php the_time2(get_option('date_format')); ?>
                </div>
