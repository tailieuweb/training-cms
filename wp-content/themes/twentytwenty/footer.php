    ...
    <div id="footer">
        <div class="container">
            <div class="row footer-height">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5 footer-height">
            ...
            <div class="row footer-height">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white footer-height">
