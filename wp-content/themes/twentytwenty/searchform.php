...
<form role="search" <?php echo $twentytwenty_aria_label; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped above. ?>
    ...
    <label for="<?php echo esc_attr($twentytwenty_unique_id); ?>" id="<?php echo esc_attr($twentytwenty_unique_id); ?>-label">
    ...
    <input type="submit" class="search-submit btn"
           style="background-color: #28a745;padding: 0.5rem 1rem;font-size: 1.25rem;line-height: 1.5;border-radius: 0.3rem;"
