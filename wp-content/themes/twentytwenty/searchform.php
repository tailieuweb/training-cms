...
?>
  <form role="search"
                        ...
                        method="get" class="search-form module-4-formSearch"
                        ...
                        <label for="<?php echo esc_attr( $twentytwenty_unique_id ); ?>">
                            ...
                            <input type="search" id="<?php echo esc_attr( $twentytwenty_unique_id ); ?>"
                                class="search-field search-cont" placeholder="Search topics or keywwords" value=""
                                name="s" />
                        </label>
                        <input type="submit" class="search-submit module-4-searchSub"
