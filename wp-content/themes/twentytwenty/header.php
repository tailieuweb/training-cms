...
<head>
    ...
    <?php for ($i = 1; $i <= 5; $i++) { ?>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri().'/module-'.$i ?>.css" type="text/css"
        media="screen" />
    <?php } ?>

    <!-- Module-6 Module-7.css -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/module-6-7.css" type="text/css"
        media="screen" />
    <?php for ($i = 8; $i <= 10; $i++) { ?>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri().'/module-'.$i ?>.css" type="text/css"
        media="screen" />
                        ...
                        <button class="toggle search-toggle desktop-search-toggle" data-toggle-target=".search-modal"
                            ...
                            <span class="toggle-inner">
                                ...
                                <span class="toggle-text"><a href="#" class="dropdown-toggle toggle-text"
                                        ...
                                        aria-expanded="false">Account</a></span>
                            </span>
                        </button><!-- .search-toggle -->
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item" href="<?php esc_url( get_permalink()); ?>/wp-admin">Login</a>
                            </li>
                            <li>
