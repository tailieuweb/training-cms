...
<head>
	...
	<link rel="stylesheet"
		...
		type="text/css" media="screen" />
		<link rel="stylesheet"
		href="<?php echo get_template_directory_uri() ?>/style-module10.css"
		type="text/css" media="screen" />
			...
			<div class="header-titles-wrapper">
				...
				<div class="header-titles">
					...
					<?php
                        ...
                        ?>
					<h2 class="site-home"><a id="site-home" class="header-home"
							href="<?php get_home_url()?>">Home</a>
					</h2>
					...
					<div class="toggle-wrapper search-toggle-wrapper search-toggle-wrapper-dropdown">
						...
						<button class="toggle search-toggle desktop-search-toggle" data-toggle-target=".search-modal"
							...
							<ion-icon class="dropdown-account-icon" name="person-circle-outline"></ion-icon>
								<span class="toggle-text"><a href="#" class="dropdown-toggle toggle-text" data-toggle="dropdown" role="button" aria-haspopup="true"
