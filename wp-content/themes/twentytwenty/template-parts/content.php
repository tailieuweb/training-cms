...
*/
		...
		<!-- Chung Tạo module 10 -->
		<div class="col-md-3">
			<h5 style="margin-bottom: 10px; font-size:200%; ">Recent Post</h5>
			<div class="RecentPost">
				<div class="crossedbg"></div>
				<div class="ul-recent">
					<ul>
						<?php $arrRecent = get_posts('recent-post');
						foreach ($arrRecent as $key => $value) { ?>
							<li  class="recent-name">
								<a href="<?php echo esc_url( get_permalink( $value->ID ) ); ?>">
								<span class="recent-title"><?php echo $value->post_title; ?></span>	
							</a>
							</li>
						<?php } ?>
					</ul>
