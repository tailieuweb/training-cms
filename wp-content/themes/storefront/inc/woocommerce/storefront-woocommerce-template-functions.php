...
<?php
	...
	?>
<a class="footer-cart-contents"
    href="<?php echo esc_url(wc_get_cart_url()); ?>"><?php esc_html_e('Cart', 'storefront'); ?>
...
<nav class="storefront-product-pagination" aria-label="<?php esc_attr_e('More products', 'storefront'); ?>">
    ...
    <div class="module8-woocommerce-pre">
    ...
    <?php if ($next_product) : ?>
    <div class="module8-woocommerce-next">
    ...
    <div class="col-full">
        <div class="storefront-sticky-add-to-cart__content">
            ...
            <div class="storefront-sticky-add-to-cart__content-product-info">
                <span
                    class="storefront-sticky-add-to-cart__content-title"><?php esc_html_e('You\'re viewing:', 'storefront'); ?>
