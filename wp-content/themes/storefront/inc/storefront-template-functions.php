...
if (!function_exists('storefront_post_header')) {
    ...
    {
        ?>
		<header class="entry-header header-module5">
		<?php
...
if (!function_exists('storefront_post_content')) {
    ...
    function storefront_post_content()
    {
        ...
        if (is_singular()) {
            ...
            $image = findImgHTMLTag($post->post_content);
            $content = preg_replace("<" . $image . ">", '', $post->post_content);
            $content = $content ? $content : 'This post hasn\'t description !!';
            ?>
            <div class="row post-home">
                <div class="col-md-4">
                    <div class="img-module5">
                         <?=$image?>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="row">
                        <p class="post-title">
                            <a href="<?=$post->guid?>"><?php echo $post->post_title ?></a>
                        </p>
                    </div>
                    <div class="row">
                        <div class="content-module5">
                            <p id="post_content_css">
                                <?=substr($content, 0, 543);?>...
                            </p>
                        </div>
                    </div>
                </div>
