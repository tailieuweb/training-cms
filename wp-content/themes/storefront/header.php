...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/style-module1-woocommerce.css"
        type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/style-module7-woocommerce.css"
        type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/style-module2-woocommerce.css"
        type="text/css" media="screen" />
