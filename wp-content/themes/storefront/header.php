...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/module6.css" type="text/css"
          media="screen"/>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/module7.css" type="text/css"
          media="screen"/>
    <!-- Module module-home-categoryMenu: -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/module-home-top.css" type="text/css"
          media="screen"/>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/module-home-categoryMenu.css"
          type="text/css" media="screen"/>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/module-home-banner.css" type="text/css"
          media="screen"/>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/module-footer.css" type="text/css"
          media="screen"/>


    <!-- HUNG's Module -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/module-Hung-productList.css" type="text/css"
          media="screen"/>
    <!--    FONT AWESOME-->
            ...
            <div class="container">
                <div class="row">
                            ...
                            <form role="search" method="get" class="woocommerce-product-search"
                                ...
                                <div class="control-group">
                                    ...
                                    <input type="search"
                                           ...
                                           class="search-field"
                                           placeholder="<?php echo esc_attr__('Search here&hellip;', 'woocommerce'); ?>"
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 animate-dropdown top-cart-row">
                        ...
                        <div class="dropdown dropdown-cart"><a href="<?php echo esc_url(wc_get_cart_url()); ?>"
                                                               class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                                <div class="items-cart-inner">
                                    <div class="basket">
                                        <div class="basket-item-count"><span
                                                    class="count"><?php echo wp_kses_data(sprintf(_n('%d', '%d', WC()->cart->get_cart_contents_count(), 'storefront'), WC()->cart->get_cart_contents_count())); ?></span>
                                        </div>
                                        <div class="total-price-basket"><span class="lbl">Shopping Cart</span> <span
                                                    class="value"><?php echo wp_kses_post(WC()->cart->get_cart_subtotal()); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                            <div class="nav-outer">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown hidden-sm"><a href="#">Health & Beauty <span
