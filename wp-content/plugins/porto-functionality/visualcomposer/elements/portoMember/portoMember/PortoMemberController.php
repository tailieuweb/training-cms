...
class PortoMemberController extends Container implements Module {

	use EventsFilters;
	use WpFiltersActions;
	public function __construct() {
		if ( ! defined( 'VCV_PORTO_MEMBER_CONTROLLER' ) ) {
			$this->addFilter(
				'vcv:editor:variables vcv:editor:variables/portoMember',
				'getImageSize'
			);
			define( 'VCV_PORTO_MEMBER_CONTROLLER', true );
		}
		$this->addFilter( 'vcv:autocomplete:portoMemberIDs:render', 'getMemberIDs' );
		$this->addFilter( 'vcv:autocomplete:portoMemberCatIDs:render', 'getMemberCatIDs' );
