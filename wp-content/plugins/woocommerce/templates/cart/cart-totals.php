...
?>
<h3 class="cart-total-custom"><?php esc_html_e( 'Cart totals', 'woocommerce' ); ?></h3>

<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
    <table cellspacing="0" class="shop_table shop_table_responsive">

        <tr class="cart-subtotal">
            <th class="border-custom"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></th>
            <td class="border-custom align-right-custom" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?>
            </td>
        </tr>
        ...
        <tr class="order-total">
            <th class="border-custom"><?php esc_html_e( 'Total', 'woocommerce' ); ?></th>
            <td class="border-custom" data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>"><?php wc_cart_totals_order_total_html(); ?>
            </td>
        </tr>
