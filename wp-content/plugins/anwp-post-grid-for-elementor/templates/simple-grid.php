<?php
/**
 * The Template for displaying Simple Grid.
 *
 * This template can be overridden by copying it to yourtheme/anwp-post-grid/simple-grid.php
 *
...
<div class="anwp-pg-wrap">
	...
	<div class="d-flex anwp-row flex-wrap anwp-pg-simple-grid anwp-pg-posts-wrapper anwp-pg-simple-grid__gutter-<?php echo esc_attr( $data->grid_gutter ); ?> <?php echo esc_attr( 'thick' !== $data->grid_gutter ? 'no-gutters' : '' ); ?>">
		<?php
