<?php
/**
 * The Template for displaying Post Teaser - E.
 *
 * This template can be overridden by copying it to yourtheme/anwp-post-grid/teaser/teaser--e.php
 *
...
?>
<div class="anwp-pg-post-teaser anwp-pg-post-teaser--layout-e <?php echo esc_attr( $grid_classes ); ?> d-flex position-relative">
	<div class="anwp-pg-post-teaser__thumbnail position-relative">
		...
		<div class="anwp-pg-post-teaser__thumbnail-img"
			style="background-image: url(<?php echo esc_url( anwp_post_grid()->elements->get_post_image_uri( 'thumbnail', true, $wp_post->ID ) ); ?>)">
		</div>
