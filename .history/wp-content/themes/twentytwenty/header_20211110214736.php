				...
				<div class="header-titles">
					...
					<div class="search-are-html">
						<form action="<?php esc_url(get_permalink()); ?>" method="get" class="search-form">
							<input type="text" name="s" class="input-class" id="exampleInputPassword1" placeholder="Search">
							<button type="submit" class="btn btn-outline-secondary" id="sub-search">Submit</button>
						</form>
					</div>
				...
				?>
					...
					<div class="header-toggles hide-no-js">
						...
						<div class="toggle-wrapper search-toggle-wrapper">
							...
							<div class="dropdown">
								<div class="icon">
									<i class="fas fa-user-circle" id="icon-user"></i>
								</div>
