...
function comment_form($args = array(), $post_id = null)
{
	...
	$defaults = array(
		...
		// 'submit_button'        => '<input name="%1$s" type="submit" id="%2$s"  value="%4$s" class=" %3$s btn btn-primary">',
...
?>
	...
	<!-- Custom comment Card Leave a reply  -->
	<section class="card">
		...
		<div class="card-header">
			<ul class="nav nav-tabs card-header-tabs" role="tablist">
				<li class="nav-item">
					<i class="nav-link active" id="posts-tab" data-toggle="tab" role="tab" aria-controls="posts" aria-selected="true">
						<?php
